          ...
          <div className='col-lg-4 col-md-6 col-sm-12 pt-5 pb-5'>
            <div className='d-flex justify-content-center'>
              <div className='card pt-4 pb-4 w-50 text-center border-0'  style={{backgroundColor:"#F3F9FF"}}>
                <div className='fs-5 fw-bold'>9.5</div>
                <div>Excellent</div>
                <div>{<FaStar style={{color:"yellow"}}/>}{<FaStar style={{color:"yellow"}}/>}{<FaStar style={{color:"yellow"}}/>}{<FaStar style={{color:"yellow"}}/>}{<FaStarHalfAlt  style={{color:"yellow"}}/>}</div>
            </div>
            </div>
